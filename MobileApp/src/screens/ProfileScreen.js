...
const styles = StyleSheet.create({
  ...
  panelGrid: { flexDirection: 'row', gap: 12, marginTop: 8, flexWrap: 'wrap', justifyContent: 'center' },
  panelBtn: { flex: 1, minWidth: 140, maxWidth: 180, flexDirection: 'column', alignItems: 'center', justifyContent: 'center', paddingVertical: 16, paddingHorizontal: 12, borderRadius: 12, gap: 8},
  adminPanelBtn: { backgroundColor: '#7c3aed' },
  modPanelBtn: { backgroundColor: '#059669' },
  panelBtnText: { color: '#fff', fontWeight: '600', fontSize: 13, flexShrink: 1, textAlign: 'center' },
